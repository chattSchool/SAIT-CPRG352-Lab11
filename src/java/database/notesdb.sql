...
('saitwebapp+admin@gmail.com', true, 'Admin','Admin', 'password', 1),
('saitwebapp+anne@gmail.com', true, 'Anne','Annerson', 'password', 2),
('saitwebapp+barb@gmail.com', true, 'Barb','Barber', 'password', 2);

INSERT INTO `note` (`Title`, `Contents`, `Owner`) VALUES
('Quote #1', 'Writing is nature''s way of letting you know how sloppy your thinking is.', 'saitwebapp+anne@gmail.com'),
('Another quote', '"Java is to JavaScript as ham is to hamster." -  Jeremy Keith', 'saitwebapp+anne@gmail.com'),
('Barb''s Note', 'Anne should not see this note.', 'saitwebapp+barb@gmail.com');
